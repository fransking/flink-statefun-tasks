...
from .messages import EgressMessage

from statefun_tasks.core.statefun.kafka_egress_pb2 import KafkaProducerRecord
from statefun_tasks.core.statefun.kinesis_egress_pb2 import KinesisEgressRecord
from statefun_tasks.core.statefun.request_reply_pb2 import TypedValue
