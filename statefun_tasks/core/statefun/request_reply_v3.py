...
from statefun_tasks.core.statefun.core import parse_typename, ValueSpec, SdkAddress
from statefun_tasks.core.statefun.messages import Message, EgressMessage
from statefun_tasks.core.statefun.statefun_builder import StatefulFunctions, StatefulFunction

# generated function protocol
from statefun_tasks.core.statefun.request_reply_pb2 import ToFunction, FromFunction, Address, TypedValue
from statefun_tasks.core.statefun.storage import resolve, Cell
...
class UserFacingContext(Context):
    __slots__ = (
