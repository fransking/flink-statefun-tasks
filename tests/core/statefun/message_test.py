...
from statefun_tasks.core.statefun import message_builder
...
class MessageTestCase(unittest.TestCase):
    ...
    def test_with_type(self):
        m = message_builder(target_typename="foo/bar", target_id="a", value=5.0, value_type=statefun_tasks.core.statefun.FloatType)
        self.assertTrue(m.is_float())
        self.assertEqual(m.as_float(), 5.0)

    def test_kafka_egress(self):
        record = statefun_tasks.core.statefun.kafka_egress_message(typename="foo/bar", topic="topic", value=1337420)
