...
# Register the same functions on legacy_tasks
tasks_with_legacy_types.register(hello_workflow, **hello_workflow.defaults())
tasks_with_legacy_types.register(multi_arg_workflow, **multi_arg_workflow.defaults())
tasks_with_legacy_types.register(multi_arg_workflow_with_some_defaults, **multi_arg_workflow_with_some_defaults.defaults())
...
class LegacyArgsAndKwargsTests(unittest.IsolatedAsyncioTestCase):
    def setUp(self) -> None:
